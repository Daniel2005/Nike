  ...
  return (
    <section className="flex justify-wrap items-center max-xl:flex-col-reverse gap-10 max-container">
      <div className="flex-1">
        ...
        width={773}
        height={687}
        className=" object-contain w-[773px] h-[687px] "/>
      </div>
      <div className="flex flex-1 flex-col">
        <h2 className="mt-0 font-palanquin text-4xl capitalize font-bold lg:max-w-lg">
          <span className="text-[#147efb]">Special </span> 
          Offer
        </h2>
